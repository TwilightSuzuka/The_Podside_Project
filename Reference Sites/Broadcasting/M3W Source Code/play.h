/* play.h $Revision: 1.1 $ $Date: 2009/05/11 09:02:51 $
 ...
 */
extern void start_play_file(void);
extern void stop_play_file(void);
extern void pause_play_file(void);
extern void end_play_file(void);
extern void get_mp3_in_file(void);
